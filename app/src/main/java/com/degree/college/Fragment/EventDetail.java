 ...
 */
public class EventDetail extends Fragment implements OnBackInterface {
...
//Retrieve the value
        ...
        imageback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.eventdetail, new EventFragment()).addToBackStack(null).commit();
            }
        });
